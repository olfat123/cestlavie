...
@section('title','Weekly Verses')
@section('d-buttons')
    {{-- @can('add_coupons') --}}
    <a href="{{route('wVerse.manager.create')}}"
...
@section('d-content')
    <div class="md-card uk-margin-medium-bottom">
        <div class="md-card-content">
            <form action="{{route('wVerse.manager.index')}}">
                ...
                <div class="uk-text-right mt-20">
                    <a class="md-btn md-btn-flat md-btn-wave waves-effect waves-button"
                       href="{{route('wVerse.manager.index')}}">Reset Filters</a>
                    <button type="submit"
    ...
    @else
        <h3 class="uk-text-large ml-20">({{$wVerses->total()}}) Weekly Verses</h3>
        <div class="md-card uk-margin-medium-bottom">
            <div class="md-card-content">
        ...
        @include('layouts.admin.partials.pagination',['collection'=>$wVerses])
    @endif
@endsection
