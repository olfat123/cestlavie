...
@section('d-content')
    <div class="md-card uk-margin-medium-bottom">
        <div class="md-card-content">
            <form action="{{route('setting.manager.index')}}">
                ...
                <div class="uk-text-right mt-20">
                    <a class="md-btn md-btn-flat md-btn-wave waves-effect waves-button"
                       href="{{route('setting.manager.index')}}">Reset Filters</a>
                    <button type="submit"
    ...
    @else
        <h3 class="uk-text-large ml-20">({{$settings->total()}}) Settings</h3>
        <div class="md-card uk-margin-medium-bottom">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    <table class="uk-table uk-table-nowrap">
                        ...
                        @foreach($settings as $setting)
                            @include('pages.settings.manager.partials.info')
                        @endforeach
                        </tbody>
                    </table>
        ...
        @include('layouts.admin.partials.pagination',['collection'=>$settings])
    @endif
@endsection
